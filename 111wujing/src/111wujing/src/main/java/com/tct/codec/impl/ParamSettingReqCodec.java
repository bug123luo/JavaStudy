 ...
 * @Title:  ParamSettingReqCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年10月31日 下午3:53:02   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.ParamSettingMessageBody;
import com.tct.codec.protocol.pojo.ParamSettingReqMessage;

/**   
 * @ClassName:  ParamSettingReqCodec   
 ...
 */
public class ParamSettingReqCodec implements MessageBodyCodec{
	...
	public Object decode(JSONObject json) throws Exception {
		...
		msg.setMessageBody(json.getObject("messageBody", ParamSettingMessageBody.class));
		return msg;
	}
