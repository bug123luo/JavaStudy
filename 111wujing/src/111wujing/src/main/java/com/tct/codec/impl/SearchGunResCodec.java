 ...
 * @Title:  SearchGunResCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年12月4日 下午2:50:51   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.SearchGunResMessageBody;

/**   
 * @ClassName:  SearchGunResCodec   
 ...
 */
public class SearchGunResCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		SearchGunResMessage msg = new SearchGunResMessage();
		...
		msg.setMessageBody(json.getObject("messageBody",SearchGunResMessageBody.class));
		return msg;
	}
