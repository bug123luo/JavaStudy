 ...
 * @Title:  StartStopSearchGunReqCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年10月31日 下午4:02:56   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.StartStopSearchGunReqMessageBody;

/**   
 * @ClassName:  StartStopSearchGunReqCodec   
 ...
 */
public class StartStopSearchGunReqCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		StartStopSearchGunReqMessage msg = new StartStopSearchGunReqMessage();
		...
		msg.setMessageBody(json.getObject("messageBody", StartStopSearchGunReqMessageBody.class));
		return msg;
	}
