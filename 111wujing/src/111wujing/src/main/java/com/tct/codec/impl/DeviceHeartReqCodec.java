 ...
 * @Title:  DeviceHeartReqCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年10月31日 上午11:42:56   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.DeviceHeartReqMessageBody;

/**   
 * @ClassName:  DeviceHeartReqCodec   
 ...
 */
public class DeviceHeartReqCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		DeviceHeartReqMessage msg= new DeviceHeartReqMessage();
		...
		msg.setMessageBody(json.getObject("messageBody", DeviceHeartReqMessageBody.class));
		return msg;
	}
