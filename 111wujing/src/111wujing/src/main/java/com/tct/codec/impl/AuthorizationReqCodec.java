 ...
 * @Title:  AuthorizationReqCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年10月31日 上午11:14:24   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.AuthorizationReqMessageBody;

/**   
 * @ClassName:  AuthorizationReqCodec   
 ...
 */
public class AuthorizationReqCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		...
		AuthorizationReqMessage msg = new AuthorizationReqMessage();
		...
		msg.setMessageBody(json.getObject("messageBody", AuthorizationReqMessageBody.class));
		return msg;
	}
