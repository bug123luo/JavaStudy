 ...
 * @Title:  WatchHeartReqCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年10月31日 下午4:07:04   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.WatchHeartReqMessageBody;

/**   
 * @ClassName:  WatchHeartReqCodec   
 ...
 */
public class WatchHeartReqCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		WatchHeartReqMessage msg = new WatchHeartReqMessage();
		...
		msg.setMessageBody(json.getObject("messageBody", WatchHeartReqMessageBody.class));
		return msg;
	}
