 ...
 * @Title:  OutWarehouseReqCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年10月31日 上午11:50:12   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.OutWarehouseReqMessageBody;

/**   
 * @ClassName:  OutWarehouseReqCodec   
 ...
 */
public class OutWarehouseReqCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		...
		msg.setMessageBody(json.getObject("messageBody", OutWarehouseReqMessageBody.class));
		return msg;
	}
