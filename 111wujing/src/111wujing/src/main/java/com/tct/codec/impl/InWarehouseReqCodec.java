 ...
 * @Title:  InWarehouseReqCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年10月31日 上午11:48:15   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.InWarehouseReqMessageBody;

/**   
 * @ClassName:  InWarehouseReqCodec   
 ...
 */
public class InWarehouseReqCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		...
		msg.setMessageBody(json.getObject("messageBody", InWarehouseReqMessageBody.class));
		return msg;
	}
