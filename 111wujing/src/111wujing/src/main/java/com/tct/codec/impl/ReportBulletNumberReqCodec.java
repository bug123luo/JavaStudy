 ...
 * @Title:  ReportBulletNumberReqCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年10月31日 下午3:58:18   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.ReportBulletNumberReqMessageBody;

/**   
 * @ClassName:  ReportBulletNumberReqCodec   
 ...
 */
public class ReportBulletNumberReqCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		ReportBulletNumberReqMessage msg = new ReportBulletNumberReqMessage();
		...
		msg.setMessageBody(json.getObject("messageBody", ReportBulletNumberReqMessageBody.class));
		return msg;
	}
