 ...
 * @Title:  GetBulletNumberReqCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年10月31日 上午11:46:13   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.GetBulletNumberReqMessageBody;

/**   
 * @ClassName:  GetBulletNumberReqCodec   
 ...
 */
public class GetBulletNumberReqCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		...
		GetBulletNumberReqMessage msg = new GetBulletNumberReqMessage();
		...
		msg.setMessageBody(json.getObject("messageBody", GetBulletNumberReqMessageBody.class));
		return msg;
	}
