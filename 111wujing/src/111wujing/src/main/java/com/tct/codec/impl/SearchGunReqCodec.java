 ...
 * @Title:  SearchGunReqCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年10月31日 下午4:00:22   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.SearchGunReqMessageBody;

/**   
 * @ClassName:  SearchGunReqCodec   
 ...
 */
public class SearchGunReqCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		SearchGunReqMessage msg = new SearchGunReqMessage();
		...
		msg.setMessageBody(json.getObject("messageBody", SearchGunReqMessageBody.class));
		return msg;
	}
