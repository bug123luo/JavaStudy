 ...
 * @Title:  CancelRecipientsGunReqCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年10月31日 上午11:39:10   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.CancelRecipientsGunReqMessageBody;

/**   
 * @ClassName:  CancelRecipientsGunReqCodec   
 ...
 */
public class CancelRecipientsGunReqCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		...
		msg.setMessageBody(json.getObject("messageBody", CancelRecipientsGunReqMessageBody.class));
		return msg;
	}
