 ...
 * @Title:  BindingResCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年11月7日 上午10:59:24   
 * @version V1.0 
 ...
 */
public class BindingResCodec implements MessageBodyCodec{
	...
	public Object decode(JSONObject json) throws Exception {
		BindingResMessage msg = new BindingResMessage();
		...
		msg.setMessageBody(json.getObject("messageBody", BindingResMessageBody.class));
		return msg;
	}
