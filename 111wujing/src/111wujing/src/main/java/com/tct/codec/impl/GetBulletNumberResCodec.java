 ...
 * @Title:  GetBulletNumberResCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年11月12日 下午4:26:14   
 * @version V1.0 
...
/**   
 * @ClassName:  GetBulletNumberResCodec   
 ...
 */
public class GetBulletNumberResCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		GetBulletNumberResMessage msg = new GetBulletNumberResMessage();
		...
		msg.setMessageBody(json.getObject("messageBody",GetBulletNumberResMessageBody.class));
		return msg;
	}
