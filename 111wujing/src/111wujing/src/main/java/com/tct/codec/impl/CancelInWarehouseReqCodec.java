 ...
 * @Title:  CancelInWarehouseReqCodec.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年10月31日 上午11:32:30   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.CancelInWarehouseReqMessageBody;

/**   
 * @ClassName:  CancelInWarehouseReqCodec   
 ...
 */
public class CancelInWarehouseReqCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		CancelInWarehouseReqMessage msg = new CancelInWarehouseReqMessage();
		...
		msg.setMessageBody(json.getObject("messageBody", CancelInWarehouseReqMessageBody.class));
		return msg;
	}
