 ...
 * @Title:  CancelRecipientsGunRes.java   
 * @Package com.tct.codec.impl   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: 泰源云景科技     
 * @date:   2018年11月8日 上午11:31:47   
 * @version V1.0 
...
import com.tct.codec.protocol.pojo.CancelRecipientsGunResMessageBody;

/**   
 * @ClassName:  CancelRecipientsGunRes   
 ...
 */
public class CancelRecipientsGunResCodec implements MessageBodyCodec {
	...
	public Object decode(JSONObject json) throws Exception {
		CancelRecipientsGunResMessage msg= new CancelRecipientsGunResMessage();
		...
		msg.setMessageBody(json.getObject("messageBody", CancelRecipientsGunResMessageBody.class));
		return msg;
	}
