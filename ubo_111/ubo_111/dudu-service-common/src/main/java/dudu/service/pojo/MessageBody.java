...
public class MessageBody {
	...
	private String dir;//直径
	private String bluetoothMac; //枪支ID
	private String gunTag; //枪支编号
	private String applyTime; //枪支领用时间
	private String deadlineTime; //归还截止时间
	private String powerAlarmLevel; //电量报警级别
	private String transmitingPower; //发射功率
	...
	private String bulletNumber; //弹射发生数
	...
	public String getTransmitingPower() {
		return transmitingPower;
	}
	public void setTransmitingPower(String transmitingPower) {
		this.transmitingPower = transmitingPower;
	}
	...
	public void setBulletNumber(String bulletNumber) {
