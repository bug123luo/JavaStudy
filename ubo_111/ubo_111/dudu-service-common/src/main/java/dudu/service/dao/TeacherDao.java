...
public class TeacherDao extends DuduDaoSupport {
    ...
    public void saveOrUpdate(TeacherBean teacherBean) throws DaoException {
        super.saveOrUpdate(teacherBean);
    }

    public TeacherBean getByPhone(String phone)
            throws DaoException {

        String hql = String.format("FROM TeacherBean tea WHERE " +
                        "tea.phone=\'%s\'",
                phone);

        logger.debug(".getByPhone hql = {}", hql);
        return (TeacherBean) super.uniqueResult(hql);
    }
